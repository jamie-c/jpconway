...
const Header = () => {
    ...
    const headerClassNames = {
        navLinksHidden: "sticky top-0 w-screen z-40 bg-opacity-60 dark:bg-opacity-50 bg-pureWhite-100 dark:bg-tricornBlack-700 backdrop-filter dark:backdrop-filter backdrop-blur-lg dark:backdrop-blur-lg transition box-shadow ease",
        navLinksVisible: "fixed top-0 w-screen h-screen z-40 bg-opacity-60 dark:bg-opacity-50 bg-pureWhite-100 dark:bg-tricornBlack-700 backdrop-filter dark:backdrop-filter backdrop-blur-lg dark:backdrop-blur-lg transition box-shadow ease"
    }
